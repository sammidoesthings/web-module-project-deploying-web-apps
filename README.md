...
- [n/a] Send your team lead the link to your web app 
- [n/a] Show them that it has been added to your portfolio
- [n/a] If you don't have a portfolio, use this project time to create a portfolio, and deploy it with Vercel ([here](https://github.com/LambdaSchool/portfolio-website) is a guide for this)
- [n/a] Once you have finished, your TL will count the project as completed
